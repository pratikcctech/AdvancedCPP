...
void Reader::getTriangles(std::vector<Triangle> &triangles)
{
    ...
    //using the lamda function to dispay the string says file not found and it will get executed when there is unable of the file opening
    //the file
    std::string message="file checking";
    auto displayMsg = [&message]()mutable
    {
